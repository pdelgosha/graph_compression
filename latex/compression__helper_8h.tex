...
\begin{DoxyCode}
57 \{
58   \textcolor{keywordflow}{if} (n <= 0 or m > n or m <= 0)
59     \textcolor{keywordflow}{return} 0;
60   \textcolor{keywordflow}{return} \hyperlink{compression__helper_8cpp_ae2afb43aabe50f7d42aae8f82b5a35f4}{compute\_product}(n, m, 1) / \hyperlink{compression__helper_8cpp_ae2afb43aabe50f7d42aae8f82b5a35f4}{compute\_product}(m, m, 1);
61 \}
\end{DoxyCode}
...
\begin{DoxyCode}
30                                               \{
31   \textcolor{comment}{//cerr << " compute\_product  N " << N << " k " << k << " s " << s << endl;}
32 
33   \textcolor{keywordflow}{if} (k==1)
34     \textcolor{keywordflow}{return} N;
35   \textcolor{keywordflow}{if} (k == 0) \textcolor{comment}{// TO CHECK because there are no terms to compute product}
36     \textcolor{keywordflow}{return} 1;
37 
38   \textcolor{keywordflow}{if} (k < 0)\{
39     cerr << \textcolor{stringliteral}{" WARNING: compute\_product called for k < 0, returning 1, N  "} << N << \textcolor{stringliteral}{" k "} << k << \textcolor{stringliteral}{" s "} << s
       << endl;
40     \textcolor{keywordflow}{return} 1;
41   \}
42   \textcolor{keywordflow}{if} (N - (k-1) * s <= 0)\{ \textcolor{comment}{// the terms go negative}
43     \textcolor{comment}{//cerr << " WARNING: compute\_product called for N - (k-1) * s <= 0 " << endl;}
44     \textcolor{keywordflow}{return} 0;
45   \}
46   
47   \textcolor{comment}{// we do this by dividing the terms into two parts}
48   \textcolor{keywordtype}{int} m = k / 2; \textcolor{comment}{// the middle point}
49   mpz\_class left, right; \textcolor{comment}{// each of the half products }
50   left = \hyperlink{compression__helper_8cpp_ae2afb43aabe50f7d42aae8f82b5a35f4}{compute\_product}(N, m, s);
51   right = \hyperlink{compression__helper_8cpp_ae2afb43aabe50f7d42aae8f82b5a35f4}{compute\_product}(N-m * s, k-m, s);
52   \textcolor{keywordflow}{return} left * right;
53 \}
\end{DoxyCode}
...
\begin{DoxyCode}
65 \{
66   \textcolor{keywordflow}{if} (i == j)\{
67     \textcolor{keywordflow}{return} \hyperlink{compression__helper_8cpp_ae2afb43aabe50f7d42aae8f82b5a35f4}{compute\_product}(a[i], a[i], 1);
68   \}\textcolor{keywordflow}{else}\{
69     \textcolor{keywordtype}{int} k = (i+j)/2;
70     mpz\_class x = \hyperlink{compression__helper_8cpp_a86d8a20e022dc06b23df3b08ac10b7d1}{prod\_factorial}(a, i, k);
71     mpz\_class y = \hyperlink{compression__helper_8cpp_a86d8a20e022dc06b23df3b08ac10b7d1}{prod\_factorial}(a, k+1, j);
72     \textcolor{keywordflow}{return} x * y;
73   \}
74 \}
\end{DoxyCode}
