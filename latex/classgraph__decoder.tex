...
\begin{DoxyCode}
133 \{
134   \hyperlink{classgraph__decoder_a9dd7c3c11b8a45a12cb7c3c2d2bfa2cc}{a} = a\_;
135   \hyperlink{classgraph__decoder_a6bc1e72b2f7a913d14b789a6c2d92c1e}{n} = \hyperlink{classgraph__decoder_a9dd7c3c11b8a45a12cb7c3c2d2bfa2cc}{a}.size();
136 
137   \textcolor{keywordtype}{int} log2n = 0; \textcolor{comment}{// log of n in base 2}
138   \textcolor{keywordtype}{int} nn = \hyperlink{classgraph__decoder_a6bc1e72b2f7a913d14b789a6c2d92c1e}{n}; \textcolor{comment}{// a copy of n}
139   \textcolor{keywordflow}{while} (nn>0)\{
140     log2n ++;
141     nn = nn >> 1; \textcolor{comment}{// divide by 2}
142   \} \textcolor{comment}{// eventually, we count the number of bits in n}
143   log2n --; \textcolor{comment}{// we count extra, e.g. when n = 1, we end up having 1, rather than 0}
144   \hyperlink{classgraph__decoder_a59663482843ffa5059128bd6ed866f11}{logn2} = log2n * log2n;
145 
146   \hyperlink{classgraph__decoder_a97a9dcd5af21ece86fa91adcb41ca9cc}{init}(); \textcolor{comment}{// init x, beta and U}
147 \}
\end{DoxyCode}
...
\begin{DoxyCode}
158 \{
159   \hyperlink{classgraph__decoder_a97a9dcd5af21ece86fa91adcb41ca9cc}{init}(); \textcolor{comment}{// make x, U and beta ready for decoding }
160   \hyperlink{classgraph__decoder_ac466636b9b21122f4fa0246aa624978c}{tS} = tS\_;
161   \textcolor{comment}{//mpz\_class prod\_a\_factorial = 1; // \(\backslash\)prod\_\{i=1\}^n a\_i!}
162   \textcolor{comment}{//for (int i=0; i<a.size();i++)}
163   \textcolor{comment}{//  prod\_a\_factorial *= compute\_product(a[i], a[i], 1);}
164 
165   mpz\_class prod\_a\_factorial = \hyperlink{compression__helper_8cpp_a86d8a20e022dc06b23df3b08ac10b7d1}{prod\_factorial}(\hyperlink{classgraph__decoder_a9dd7c3c11b8a45a12cb7c3c2d2bfa2cc}{a}, 0,\hyperlink{classgraph__decoder_a9dd7c3c11b8a45a12cb7c3c2d2bfa2cc}{a}.size()-1); \textcolor{comment}{// \(\backslash\)prod\_\{i=0\}^\{n-1\} a\_i!}
166   mpz\_class tN = f * prod\_a\_factorial;
167   \hyperlink{classgraph__decoder_a2cb0bd279889a833d4c825e99eb72410}{decode\_interval}(0,\hyperlink{classgraph__decoder_a6bc1e72b2f7a913d14b789a6c2d92c1e}{n}-1,1,tN,0);
168   \textcolor{keywordflow}{return} \hyperlink{classgraph}{graph}(\hyperlink{classgraph__decoder_aa3f2776afe387668cf7f68109428e14e}{x}, \hyperlink{classgraph__decoder_a9dd7c3c11b8a45a12cb7c3c2d2bfa2cc}{a});
169 \}
\end{DoxyCode}
...
\begin{DoxyCode}
224 \{
225   \textcolor{comment}{//cerr << " decode interval " << i << " " << j << " tN " << tN << endl;}
226   \textcolor{keywordflow}{if} (i == j)
227     \textcolor{keywordflow}{return} \hyperlink{classgraph__decoder_af3ff99a4de6035ad257ebd7c6519cdd8}{decode\_node}(i, tN);
228 
229   \textcolor{comment}{// sweeping for zero nodes}
230 
231   \textcolor{keywordtype}{int} t; \textcolor{comment}{// place to break}
232   \textcolor{keywordtype}{int} St; \textcolor{comment}{// S\_\{t+1\}}
233   \textcolor{keywordflow}{if} ((j-i) > \hyperlink{classgraph__decoder_a59663482843ffa5059128bd6ed866f11}{logn2})\{
234     \textcolor{comment}{//cerr << " long interval I = " << I << endl;}
235     t = (i+j) / 2; \textcolor{comment}{// break at middle, since we have \(\backslash\)tilde\{S\}}
236     St = \hyperlink{classgraph__decoder_ac466636b9b21122f4fa0246aa624978c}{tS}[I]; \textcolor{comment}{// looking at the \(\backslash\)f$\(\backslash\)tilde\{S\}\(\backslash\)f$ vector}
237   \}\textcolor{keywordflow}{else}\{
238     \textcolor{comment}{//cerr << " short interval " << endl;}
239     t = i;
240     St = \hyperlink{classgraph__decoder_a2fa9fec2cef06aaa410e57fb59d5c1ad}{U}.\hyperlink{classreverse__fenwick__tree_a672731fd6395b4853430073a099a80e6}{sum}(i) - 2 * \hyperlink{classgraph__decoder_aa57c11e4c09c52101682ff83286162f7}{beta}[i];
241   \}
242 
243   \textcolor{comment}{//cerr << " decode interval " << i << " " << j << " t " << t << " St " << St << " Sj " << Sj << endl;}
244   mpz\_class rtj; \textcolor{comment}{// \(\backslash\)f$t\_\{t+1, j\}\(\backslash\)f$}
245   mpz\_class tNit; \textcolor{comment}{// \(\backslash\)f$\(\backslash\)tilde\{N\}\_\{i,t\}\(\backslash\)f$ for the left decoder}
246   mpz\_class tNtj; \textcolor{comment}{// \(\backslash\)f$\(\backslash\)tilde\{N\}\_\{t+1, j\}\(\backslash\)f$ for the right decoder }
247   mpz\_class Nit; \textcolor{comment}{// the true N\_\{i,t\} returned by the left decoder}
248   mpz\_class lit; \textcolor{comment}{// the true l\_\{i,t\} returned by the left decoder}
249   mpz\_class Ntj; \textcolor{comment}{// the true N\_\{t+1, j\} returned by the right decoder}
250   mpz\_class ltj; \textcolor{comment}{// the true l\_\{t+1,j\} returned by the right decoder}
251   mpz\_class Nij; \textcolor{comment}{// the true N\_\{i,j\} to return}
252   mpz\_class lij; \textcolor{comment}{// the true l\_\{i,j\} to return}
253 
254   pair<mpz\_class, mpz\_class> ans; \textcolor{comment}{// returned by subintervals }
255 
256 
257   rtj = \hyperlink{compression__helper_8cpp_ae2afb43aabe50f7d42aae8f82b5a35f4}{compute\_product}(St - 1, (St - Sj)/2, 2);
258   \textcolor{comment}{//cerr << " interval " << i << " " << j << " t " << t << " St " << St << " rtj " << rtj << endl;}
259   tNit = tN / rtj;
260 
261   \textcolor{comment}{// calling the left decoder }
262   ans = \hyperlink{classgraph__decoder_a2cb0bd279889a833d4c825e99eb72410}{decode\_interval}(i,t,2*I,tNit, St); 
263   Nit = ans.first;
264   lit = ans.second;
265 
266   \textcolor{comment}{// reducing the contribution of the left decoder to prepare for the right decoder}
267   tNtj = (tN - Nit * rtj) / lit;
268 
269   \textcolor{comment}{// calling the right decoder}
270   ans = \hyperlink{classgraph__decoder_a2cb0bd279889a833d4c825e99eb72410}{decode\_interval}(t+1, j, 2*I + 1, tNtj, Sj);
271   Ntj = ans.first;
272   ltj = ans.second;
273 
274   \textcolor{comment}{// preparing Nij and lij to return}
275   Nij = Nit * rtj + lit * Ntj;
276   lij = lit * ltj;
277   \textcolor{keywordflow}{return} pair<mpz\_class, mpz\_class> (Nij, lij);
278 \}
\end{DoxyCode}
...
\begin{DoxyCode}
172 \{
173   \textcolor{comment}{//cerr << " decode node " << i << " tN " << tN << endl;}
174   \textcolor{comment}{//cerr << " beta[i] " << beta[i] << endl;}
175   \textcolor{comment}{//cerr << " beta " << endl;}
176   \textcolor{comment}{//for (int k = i; k< n;k++)}
177   \textcolor{comment}{//  cerr << k << " " << beta[k] << endl;}
178   \textcolor{comment}{//cerr << " U " << endl;}
179   \textcolor{comment}{//for (int k=i;k<n;k++)}
180   \textcolor{comment}{//  cerr << k << " " << U.sum(k) << endl;}
181 
182   \textcolor{keywordflow}{if} (\hyperlink{classgraph__decoder_aa57c11e4c09c52101682ff83286162f7}{beta}[i] == 0)
183     \textcolor{keywordflow}{return} pair<mpz\_class, mpz\_class> (0,1);
184 
185   mpz\_class li = 1; \textcolor{comment}{// l\_i(G)}
186   mpz\_class Ni = 0; \textcolor{comment}{// N\_\{i,i\}(G)}
187   \textcolor{keywordtype}{int} f, g; \textcolor{comment}{// endpoints for the binary search}
188   \textcolor{keywordtype}{int} t; \textcolor{comment}{// midpoint for the binary search}
189   mpz\_class zik, lik; 
190   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} k=0;k<\hyperlink{classgraph__decoder_aa57c11e4c09c52101682ff83286162f7}{beta}[i];k++)\{
191     \textcolor{keywordflow}{if} (k==0)
192       f = i+1;
193     \textcolor{keywordflow}{else}
194       f = \hyperlink{classgraph__decoder_aa3f2776afe387668cf7f68109428e14e}{x}[i][k-1]+1;
195     g = \hyperlink{classgraph__decoder_a6bc1e72b2f7a913d14b789a6c2d92c1e}{n}-1;
196     \textcolor{keywordflow}{while}(g > f)\{
197       \textcolor{comment}{//cerr << " f , g " << f << " " << g << endl;}
198       t = (f+g)/2;
199       \textcolor{comment}{// binary search:}
200       \textcolor{keywordflow}{if}(\hyperlink{compression__helper_8cpp_ae2afb43aabe50f7d42aae8f82b5a35f4}{compute\_product}(\hyperlink{classgraph__decoder_a2fa9fec2cef06aaa410e57fb59d5c1ad}{U}.\hyperlink{classreverse__fenwick__tree_a672731fd6395b4853430073a099a80e6}{sum}(t+1), beta[i] - k, 1) <= tN)
201         g = t;
202       \textcolor{keywordflow}{else}
203         f = t+1;
204     \}
205     \hyperlink{classgraph__decoder_aa3f2776afe387668cf7f68109428e14e}{x}[i].push\_back(f);
206     zik = \hyperlink{compression__helper_8cpp_ae2afb43aabe50f7d42aae8f82b5a35f4}{compute\_product}(\hyperlink{classgraph__decoder_a2fa9fec2cef06aaa410e57fb59d5c1ad}{U}.\hyperlink{classreverse__fenwick__tree_a672731fd6395b4853430073a099a80e6}{sum}(\hyperlink{classgraph__decoder_aa3f2776afe387668cf7f68109428e14e}{x}[i][k]+1), beta[i] - k, 1);
207     Ni += li * zik;
208     lik = (beta[i] - k) * beta[\hyperlink{classgraph__decoder_aa3f2776afe387668cf7f68109428e14e}{x}[i][k]];
209     li *= lik;
210     tN -= zik;
211     tN /= lik;
212     \hyperlink{classgraph__decoder_a2fa9fec2cef06aaa410e57fb59d5c1ad}{U}.\hyperlink{classreverse__fenwick__tree_a942d7f49b37e53ebfec3076d177691d7}{add}(\hyperlink{classgraph__decoder_aa3f2776afe387668cf7f68109428e14e}{x}[i][k],-1);
213     beta[\hyperlink{classgraph__decoder_aa3f2776afe387668cf7f68109428e14e}{x}[i][k]] --;
214   \}
215   \textcolor{comment}{//cerr << " decoded for " << i << " x: " << endl;}
216   \textcolor{comment}{//for (int j=0;j<x[i].size(); j++)}
217   \textcolor{comment}{//  cerr << x[i][j] << " " ;}
218   \textcolor{comment}{//cerr << endl;}
219   \textcolor{keywordflow}{return} pair<mpz\_class, mpz\_class> (Ni, li);
220 \}
\end{DoxyCode}
...
\begin{DoxyCode}
150 \{
151   \hyperlink{classgraph__decoder_aa3f2776afe387668cf7f68109428e14e}{x}.clear();
152   \hyperlink{classgraph__decoder_aa3f2776afe387668cf7f68109428e14e}{x}.resize(\hyperlink{classgraph__decoder_a6bc1e72b2f7a913d14b789a6c2d92c1e}{n});
153   \hyperlink{classgraph__decoder_aa57c11e4c09c52101682ff83286162f7}{beta} = \hyperlink{classgraph__decoder_a9dd7c3c11b8a45a12cb7c3c2d2bfa2cc}{a};
154   \hyperlink{classgraph__decoder_a2fa9fec2cef06aaa410e57fb59d5c1ad}{U} = \hyperlink{classreverse__fenwick__tree}{reverse\_fenwick\_tree}(\hyperlink{classgraph__decoder_a9dd7c3c11b8a45a12cb7c3c2d2bfa2cc}{a});
155 \}
\end{DoxyCode}
