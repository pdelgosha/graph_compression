...
85     \textcolor{comment}{//o << " adj list (connections to vertices with greater index): format (j, (x,y))" << endl;}
86     o << \textcolor{stringliteral}{" adj list "} << endl;
87     l = G.\hyperlink{classmarked__graph_a1a0bf7ca413a278763f7c878b3b6fd6f}{adj\_list}[v];
88     sort(l.begin(), l.end(), \hyperlink{marked__graph_8cpp_a09dd24caed50b1d106e10538e688b6ac}{edge\_compare});
89     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0;i<l.size();i++)\{
90       \textcolor{keywordflow}{if} (l[i].first > v)
91         o << \textcolor{stringliteral}{" ("} << l[i].first << \textcolor{stringliteral}{", ("} << l[i].second.first << \textcolor{stringliteral}{", "} << l[i].second.second << \textcolor{stringliteral}{")) "};
92     \}
93     o << endl << endl;
94   \}
95   \textcolor{keywordflow}{return} o;
96 \}
\end{DoxyCode}
