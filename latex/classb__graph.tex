...
26     cerr << \textcolor{stringliteral}{" v "} << v << endl;
27     sort(\hyperlink{classb__graph_a2a89d2e8f958270952aab2e8769b7342}{adj\_list}[v].begin(), \hyperlink{classb__graph_a2a89d2e8f958270952aab2e8769b7342}{adj\_list}[v].end());
28     \textcolor{keywordflow}{if} (\hyperlink{classb__graph_a2a89d2e8f958270952aab2e8769b7342}{adj\_list}[v].size() > 0 and \hyperlink{classb__graph_a2a89d2e8f958270952aab2e8769b7342}{adj\_list}[v][\hyperlink{classb__graph_a2a89d2e8f958270952aab2e8769b7342}{adj\_list}[v].size()-1] > 
      \hyperlink{classb__graph_acffdd5f20329515eb6ec17ad24f1ca64}{np})
29       \hyperlink{classb__graph_acffdd5f20329515eb6ec17ad24f1ca64}{np} = \hyperlink{classb__graph_a2a89d2e8f958270952aab2e8769b7342}{adj\_list}[v][\hyperlink{classb__graph_a2a89d2e8f958270952aab2e8769b7342}{adj\_list}[v].size()-1];
30     \hyperlink{classb__graph_a311d16462dbb10c47b3a6c80a42139d9}{left\_deg\_seq}[v] = adj\_list[v].size();
31   \}
32   \hyperlink{classb__graph_acffdd5f20329515eb6ec17ad24f1ca64}{np}++; \textcolor{comment}{// node indexing is zero based}
33   
34   \hyperlink{classb__graph_ae4c875ed6a583a78f38dfe958f20fad5}{right\_deg\_seq}.resize(\hyperlink{classb__graph_acffdd5f20329515eb6ec17ad24f1ca64}{np});
35   fill(\hyperlink{classb__graph_ae4c875ed6a583a78f38dfe958f20fad5}{right\_deg\_seq}.begin(), \hyperlink{classb__graph_ae4c875ed6a583a78f38dfe958f20fad5}{right\_deg\_seq}.end(), 0); \textcolor{comment}{// make all elements 0}
36   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} v=0;v<list.size();v++)
37     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0;i<list[v].size();i++)
38       \hyperlink{classb__graph_ae4c875ed6a583a78f38dfe958f20fad5}{right\_deg\_seq}[list[v][i]]++;
39 \}
\end{DoxyCode}
