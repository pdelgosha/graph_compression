...
93     rtj = \hyperlink{compression__helper_8cpp_ac683dff9ff89796df0ab62cd65c30990}{compute\_product}(St-1, (St - Sj)/2, 2);
...
107 
108   mpz\_class prod\_a\_factorial = \hyperlink{compression__helper_8cpp_a86d8a20e022dc06b23df3b08ac10b7d1}{prod\_factorial}(\hyperlink{classgraph__encoder_a56eb5cf480ae5c2fca9f3a45f2ffd4f1}{a}, 0,\hyperlink{classgraph__encoder_a56eb5cf480ae5c2fca9f3a45f2ffd4f1}{a}.size()-1); \textcolor{comment}{// \(\backslash\)prod\_\{i=1\}^n a\_i!}
109   \textcolor{comment}{// we need the ceiling of the ratio of N\_ans.first and prod\_a\_factorial}
110   \textcolor{keywordtype}{bool} ceil = \textcolor{keyword}{false}; \textcolor{comment}{// if true, we will add one to the integer division}
111   \textcolor{keywordflow}{if} (N\_ans.first % prod\_a\_factorial != 0)
112     ceil = \textcolor{keyword}{true};
113   N\_ans.first /= prod\_a\_factorial;
114   \textcolor{keywordflow}{if} (ceil)
115     N\_ans.first ++;
116   \textcolor{keywordflow}{return} pair<mpz\_class, vector<int> > (N\_ans.first, \hyperlink{classgraph__encoder_a342688a3fdee511b7fae3f155cfb10cf}{Stilde});
117 \}
\end{DoxyCode}
